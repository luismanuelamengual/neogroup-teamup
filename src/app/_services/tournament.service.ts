...
/** Server-side tournament domain logic (used only by API route handlers). */
...
export async function createTournament(userId: number, input: CreateTournamentInput): Promise<ServiceResult> {
...
async function createRound(tournament: Tournament, roundNumber: number): Promise<ServiceResult> {
...
export async function startTournament(userId: number, tournamentId: number): Promise<ServiceResult> {
  const tournament = await requireOwnedTournament(tournamentId, userId)
...
export async function closeCurrentRound(userId: number, tournamentId: number): Promise<ServiceResult> {
  const tournament = await requireOwnedTournament(tournamentId, userId)
...
export async function startNextRound(userId: number, tournamentId: number): Promise<ServiceResult> {
  const tournament = await requireOwnedTournament(tournamentId, userId)
  ...
  return createRound(tournament, tournament.currentRound + 1)
}

/** Marks the tournament as finished. */
export async function finishTournament(userId: number, tournamentId: number): Promise<ServiceResult> {
  const tournament = await requireOwnedTournament(tournamentId, userId)
 ...
 */
export async function saveMatchResult(userId: number, matchId: number, score: MatchScore): Promise<ServiceResult> {
