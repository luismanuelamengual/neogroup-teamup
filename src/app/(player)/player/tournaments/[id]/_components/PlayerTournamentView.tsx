...
import { leaveTournament } from '@/app/_actions/registration'
import { getTournamentDetail, saveMatchResult, TournamentDetailWithEntry } from '@/app/_actions/tournament'
