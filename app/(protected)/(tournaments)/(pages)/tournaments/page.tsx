...
import OrganizerTournamentsList from '@/app/(protected)/(tournaments)/components/OrganizerTournamentsList'
import PlayerTournamentsList from '@/app/(protected)/(tournaments)/components/PlayerTournamentsList'
import TournamentFilters from '@/app/(protected)/(tournaments)/components/TournamentFilters'
