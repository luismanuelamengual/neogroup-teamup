...
export function TournamentCardSkeleton() {
  return (
    <Paper className="tournament-card tournament-card-skeleton" sx={{ pointerEvents: 'none', transform: 'none' }}>
      <div className="card-body">
        <MuiSkeleton
          variant="rounded"
          className="poster"
          width={96}
          height={130}
          sx={{ borderRadius: 'var(--radius-md, 8px)', flexShrink: 0, transform: 'none' }}
        />
        <div className="card-content">
          <div className="header">
